...
class PredictionArgs(argparse.ArgumentParser):
    def __init__(
        ...
        self.add_argument(
            ...
            type=str,
            # default="test",
            default="hetro_gap_homo_ea_ip_reorganisation_oxidation",
        ...
        self.add_argument("--noise-std", type=float, default=0)
        self.add_argument("--normalize", type=bool, default=True)

        self.add_argument("--batch-size", type=int, default=1024)
