...
os.chdir("/home/tomerweiss/PBHs-design")
...
from prediction.train_cond_predictor import (
...
if __name__ == "__main__":
    ...
    pred_args.name = "hetro_gap_homo_ea_ip_stability_polynomial_5_with_norm"
    pred_args.name = "cata_lumo_gap_erel_ip_ea_polynomial_2_with_norm"
    pred_args.exp_dir = f"{pred_args.save_dir}/cond_predictor/{pred_args.name}"
