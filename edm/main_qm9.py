...
parser.add_argument("--exp_name", type=str, default="edm_qm9_alpha")
parser.add_argument(
    "--model",
    type=str,
...
parser.add_argument("--dp", type=eval, default=False, help="True | False")
...
# EGNN args -->
parser.add_argument("--n_layers", type=int, default=4, help="number of layers")  # 9
parser.add_argument("--inv_sublayers", type=int, default=1, help="number of layers")
parser.add_argument("--nf", type=int, default=128, help="number of layers")  # 256
...
parser.add_argument(
    "--dataset",
    type=str,
    default="qm9_second_half",
    help="qm9 | qm9_second_half (train only on the last 50K samples of the training dataset)",
)
parser.add_argument(
    "--datadir",
    type=str,
    default="/home/tomerweiss/PBHs-design/edm/qm9/temp",
    help="qm9 directory",
)
parser.add_argument(
    "--filter_n_atoms",
...
parser.add_argument("--n_report_steps", type=int, default=100)
